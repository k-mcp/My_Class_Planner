...
- **목표**: 해외 대학생들을 위한 학습 관리 시스템(LMS) 개발


- **설명**: 해외 대학생을 위한 효율적인 학습 일정 관리를 위한 LMS 시스템


- **의의**: 학생들이 학업 일정을 효율적으로 관리하고 학습 계획을 세울 수 있도록 도움


- **배경**: 해외 대학생들의 학업 일정 관리를 개선하고 더 효율적인 시간 활용을 위해 시작
...
| 이름    | 역할         | 깃허브 주소                   |
|---------|--------------|-------------------------------|
| 유정우  | 팀장, Server, OPEN AI, Algorithm | [유정우의 깃허브](https://github.com/Jungwoo-Ryu) |
| 이은숙  | 업무관리, DB 관리, 테스트관리 | [이은숙의 깃허브](https://github.com/Leeeunsookl) |
| 이혜진  | 문서관리, DB 관리 | [이혜진의 깃허브](https://github.com/tesla1220) |
| 정고은  | Server, UI   | [정고은의 깃허브](https://github.com/GonY0624) |
...
1. 회원가입/로그인
2. 시간표 조회
3. 시간표 생성기 (Time Table Generator)
4. 수강신청 쇼핑카트
